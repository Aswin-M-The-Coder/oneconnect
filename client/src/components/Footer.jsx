...
function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 w-full text-center text-violet-200 text-sm p-3 bg-violet-900">
      &copy; {year} Copyright{" "}
      <a className="text-cyan-200" href="aswinmportfolio.netlify.app" target="_blank" rel="noreferrer">
        Aswin M
      ...
      {" # "}
      <a className="text-cyan-200" href="https://github.com/Aswin-M-The-Coder" target="_blank" rel="noreferrer">
        GitHub Repo
      </a>
    </footer>
  );
